...
typedef BaseType_t (*Channel_callback)(void            *ctx,
                                       const void      *data,
...
void
inline
channel_init_consumer(Channel_consumer *ch,
                      const char       *identifier,
                      QueueHandle_t     queue)
{
...
void
inline
channel_init_producer(Channel_producer *ch,
                      const char       *identifier)
{
...
void
inline
channel_setCallback(Channel               *ch,
 ...
 */
BaseType_t
channel_send(const Channel_consumer *ch,
             const void             *data,
             const TickType_t        timeout);
...
void
inline
channel_broadcast_init(Channel_broadcast      *handle,
                       const Channel_producer *ch,
                       const void             *data,
                       const TickType_t        timeout)
{
    handle->ch      = (void*)ch;
...
bool
inline
channel_broadcast_timeout(Channel_broadcast *handle)
{
...
bool
inline
channel_broadcast_finished(const Channel_broadcast *handle)
{
 ...
 */
BaseType_t
channel_broadcast(Channel_broadcast *handle);
