 ...
 * @handle: Provides a reference to the queue.
 * @buffer: Stores the address of the queues' buffer.
 *
 ...
 * @buffersize: The queues item count multiplied with the size of an item.
 *
